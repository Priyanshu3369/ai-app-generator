...
export async function GET(
  ...
  try {
    ...
    if (id) {
      const record = await findOne(appId, model, id, userId, modelConfig.userScoped);
...
export async function POST(
  ...
  try {
    ...
    const record = await create(appId, model, body, user?.userId, modelConfig.userScoped);
...
export async function PUT(
  ...
  try {
    ...
    const user = authenticateRequest(request);
    const record = await update(appId, model, body.id, body, user?.userId, modelConfig.userScoped);
...
export async function DELETE(
  ...
  try {
    ...
    const user = authenticateRequest(request);
    await remove(appId, model, id, user?.userId, modelConfig.userScoped, modelConfig.softDelete);
